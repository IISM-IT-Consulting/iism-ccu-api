...
if {$downloadCmd} {
  ...
  puts "<html><head><meta http-equiv='refresh' content='0; url=https://github.com/IISM-IT-Consulting/iism-ccu-api/releases' /></head></html>"
} else {
  # retrieve version of latest release
  set infoUrl https://api.github.com/repos/IISM-IT-Consulting/iism-ccu-api/releases/latest
  set infoError [catch {
